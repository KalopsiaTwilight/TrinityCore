...
void LoadNpcTele(void)
{
    ...
    if (result)
    {
        TC_LOG_INFO("misc", "TSCR: Loading %s, %s and %s...", Table[0], Table[1], Table[2]);
        ...
        TC_LOG_INFO("misc", "");
        TC_LOG_INFO("misc", "TSCR: >> Loaded %u npc_teleport.", nbDest);
    } else TC_LOG_INFO("misc", "TSCR: WARNING >> Loaded 0 npc_teleport.");
}
