...
//                                        = 752, see LANG_PINFO_ACC_IP
    ...
    FREEDOM_CMDH_MOD_SPEED                          = 100013,
    FREEDOM_CMDI_MOD_SPEED                          = 100014,
    FREEDOM_CMDE_VALUE_OUT_OF_RANGE                 = 100015,
    FREEDOM_CMDH_FLY                                = 100016,
    FREEDOM_CMDI_FLY                                = 100017,
    FREEDOM_CMDI_DEMORPH                            = 100018,
    FREEDOM_CMDH_SCALE                              = 100019,
    FREEDOM_CMDI_SCALE                              = 100020,
    FREEDOM_CMDI_UNAURA                             = 100021,
    FREEDOM_CMDI_REVIVE                             = 100022,
    FREEDOM_CMDE_REVIVE                             = 100023,
    FREEDOM_CMDH_SUMMON                             = 100024,
    FREEDOM_CMDI_SUMMON                             = 100025,
    FREEDOM_CMDE_SUMMON_NOT_FOUND                   = 100026,
    ...
    FREEDOM_CMDI_SEARCH_QUERY_RESULT                = 100032,
    FREEDOM_CMDE_X_WITH_NAME_NOT_FOUND              = 100033,
    FREEDOM_CMDE_X_WITH_ID_NOT_FOUND                = 100034,
    FREEDOM_CMDI_X_NONE_FOUND_WITH_NAME             = 100035,
    FREEDOM_CMDE_X_WITH_NAME_ALREADY_EXISTS         = 100036,
    FREEDOM_CMDE_X_WITH_ID_ALREADY_EXISTS           = 100037,
    FREEDOM_CMDI_X_ADDED_WITH_NAME                  = 100038,
    FREEDOM_CMDI_X_WITH_NAME_REMOVED                = 100039,
    FREEDOM_CMDH_PUBLIC_TELE                        = 100040,
    FREEDOM_CMDH_PUBLIC_TELE_LIST                   = 100041,
    FREEDOM_CMDI_PUBLIC_TELE_LIST_ITEM              = 100042,
    FREEDOM_CMDH_PUBLIC_TELE_ADD                    = 100043,
    FREEDOM_CMDH_PUBLIC_TELE_DEL                    = 100044,
    FREEDOM_CMDH_PRIVATE_TELE                       = 100045,
    FREEDOM_CMDH_PRIVATE_TELE_LIST                  = 100046,
    FREEDOM_CMDI_PRIVATE_TELE_LIST_ITEM             = 100047,
    FREEDOM_CMDH_PRIVATE_TELE_ADD                   = 100048,
    FREEDOM_CMDH_PRIVATE_TELE_DEL                   = 100049,
    FREEDOM_CMDH_PUBLIC_SPELL                       = 100050,
    FREEDOM_CMDH_PUBLIC_SPELL_LIST                  = 100051,
    FREEDOM_CMDI_PUBLIC_SPELL_LIST_ITEM             = 100052,
    FREEDOM_CMDH_PUBLIC_SPELL_ADD                   = 100053,
    FREEDOM_CMDH_PUBLIC_SPELL_DEL                   = 100054,
    FREEDOM_CMDH_MORPH                              = 100055,
    FREEDOM_CMDH_MORPH_LIST                         = 100056,
    FREEDOM_CMDI_MORPH_LIST_ITEM                    = 100057,
    ...
    FREEDOM_CMDI_MORPH_DEL                          = 100065,
    FREEDOM_CMDI_PUBLIC_SPELL_ADD                   = 100066,
    ...
    FREEDOM_CMDE_GAMEOBJECT_SPAWN_FAIL              = 100084,
    FREEDOM_CMDI_GAMEOBJECT_SPAWN                   = 100085,
    FREEDOM_CMDE_GAMEOBJECT_SPAWN_INVALID_DISPLAY   = 100086,
    FREEDOM_CMDI_GAMEOBJECT_NEAR                    = 100087,
    FREEDOM_CMDI_GAMEOBJECT_NEAR_MAX_RESULT_COUNT   = 100088,
    FREEDOM_CMDE_GAMEOBJECT_GUID_NOT_EXISTS         = 100089,
    FREEDOM_CMDE_GAMEOBJECT_ENTRY_NOT_EXISTS        = 100090,
    FREEDOM_CMDI_GAMEOBJECT_NEAR_LIST_ITEM          = 100091,
    FREEDOM_CMDI_GAMEOBJECT_MOVE                    = 100092,
    FREEDOM_CMDE_INVALID_TARGET_COORDS              = 100093,
    FREEDOM_CMDE_GAMEOBJECT_NOT_FOUND               = 100094,
    FREEDOM_CMDI_GAMEOBJECT_TURNED                  = 100095,
    FREEDOM_CMDI_GAMEOBJECT_DELETE                  = 100096,
    FREEDOM_CMDI_GAMEOBJECT_SET_STATE               = 100097,
    FREEDOM_CMDH_GAMEOBJECT_SET_STATE               = 100098,
    FREEDOM_CMDH_GAMEOBJECT_SCALE                   = 100099,
    FREEDOM_CMDI_GAMEOBJECT_SCALE                   = 100100,
    FREEDOM_CMDI_GAMEOBJECT_INFO                    = 100101,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_GUID_FULL       = 100102,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_GUID            = 100103,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_ENTRY           = 100104,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_DISPLAY_ID      = 100105,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_SCRIPT_ID       = 100106,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_NAME            = 100107,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_AI_NAME         = 100108,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_PHASEMASK       = 100109,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_PHASELIST       = 100110,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_PHASE_LI        = 100111,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_POS_X           = 100112,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_POS_Y           = 100113,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_POS_Z           = 100114,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_ORIENTATION     = 100115,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_DISTANCE        = 100116,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_SCALE           = 100117,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_STATE           = 100118,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_CREATOR_PLAYER  = 100119,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_CREATOR_ACC     = 100120,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_MODIFIER_PLAYER = 100121,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_MODIFIER_ACC    = 100122,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_CREATED         = 100123,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_MODIFIED        = 100124,
    FREEDOM_CMDI_GAMEOBJECT_INFO_LI_NO_HISTORY      = 100125,
    FREEDOM_CMDH_GAMEOBJECT_PHASE                   = 100126,
    FREEDOM_CMDI_GAMEOBJECT_PHASE_BITFIELDS         = 100127,
    FREEDOM_CMDI_GAMEOBJECT_PHASE_PHASEIDS          = 100128,
    FREEDOM_CMDE_GAMEOBJECT_PHASE_NOT_SET           = 100129,
    FREEDOM_CMDH_MODIFY_PHASE                       = 100130,
    FREEDOM_CMDI_MODIFY_PHASE_BITFIELDS             = 100131,
    FREEDOM_CMDI_MODIFY_PHASE_PHASEIDS              = 100132,
    FREEDOM_CMDE_MODIFY_PHASE_NOT_SET               = 100133,
    FREEDOM_CMDE_CREATURE_NOT_FOUND                 = 100134,
    FREEDOM_CMDE_GAMEOBJECT_IS_BLACKLISTED          = 100135,
    FREEDOM_CMDH_BLACKLIST_GAMEOBJECT               = 100136,
    FREEDOM_CMDI_BLACKLIST_GAMEOBJECT               = 100137,
    FREEDOM_CMDE_CREATURE_IS_BLACKLISTED            = 100138,
    FREEDOM_CMDH_BLACKLIST_CREATURE                 = 100139,
    FREEDOM_CMDI_BLACKLIST_CREATURE                 = 100140,
    FREEDOM_CMDH_NPC_ADD                            = 100141,
    FREEDOM_CMDE_NPC_ADD_FAIL                       = 100142,
    FREEDOM_CMDI_NPC_ADD                            = 100143,
    FREEDOM_CMDH_NPC_ADD_ITEM                       = 100144,
    FREEDOM_CMDE_MANUAL_SELECT_CREATURE             = 100145,
    FREEDOM_CMDE_INVALID_ITEM_ID                    = 100146,
    FREEDOM_CMDE_INVALID_ITEM_NOT_EXISTS            = 100147,
    FREEDOM_CMDI_NPC_ADD_ITEM                       = 100148,
    FREEDOM_CMDE_NPC_ADD_ITEM_CANNOT_ADD            = 100149,
    FREEDOM_CMDE_NPC_ADD_FORMATION_ALREADY_IN       = 100150,
    FREEDOM_CMDI_NPC_ADD_FORMATION                  = 100151,
    FREEDOM_CMDE_NPC_ADD_FORMATION_LEADER_NOT_FOUND = 100152,
    FREEDOM_CMDH_CREATURE_PHASE                     = 100153,
    FREEDOM_CMDI_CREATURE_PHASE_BITFIELDS           = 100154,
    FREEDOM_CMDI_CREATURE_PHASE_PHASEIDS            = 100155,
    FREEDOM_CMDE_CREATURE_PHASE_NOT_SET             = 100156,
    FREEDOM_CMDE_CREATURE_GUID_NOT_EXISTS           = 100157,
    FREEDOM_CMDE_CREATURE_ENTRY_NOT_EXISTS          = 100158,
    FREEDOM_CMDE_CREATURE_CANNOT_EXECUTE_ON_PETS    = 100159,
    FREEDOM_CMDH_NPC_SET_SCALE                      = 100160,
    FREEDOM_CMDI_NPC_SET_SCALE                      = 100161,
    FREEDOM_CMDH_NPC_SET_ALLOWMOVEMENT              = 100162,
    FREEDOM_CMDI_NPC_SET_ALLOWMOVEMENT_OFF          = 100163,
    FREEDOM_CMDI_NPC_SET_ALLOWMOVEMENT_ON           = 100164,
    FREEDOM_CMDH_NPC_SET_ENTRY                      = 100165,
    FREEDOM_CMDI_NPC_SET_ENTRY                      = 100166,
    FREEDOM_CMDE_NPC_SET_ENTRY_FAIL                 = 100167,
    FREEDOM_CMDH_NPC_SET_LEVEL                      = 100168,
    FREEDOM_CMDE_NPC_SET_LEVEL_BAD_VALUE            = 100169,
    FREEDOM_CMDI_NPC_SET_LEVEL                      = 100170,
    FREEDOM_CMDE_CREATURE_CANNOT_BE_PET_OR_TOTEM    = 100171,
    FREEDOM_CMDE_CREATURE_CANNOT_BE_PET             = 100172,
    FREEDOM_CMDE_CREATURE_CANNOT_BE_TOTEM           = 100173,
    FREEDOM_CMDI_NPC_DELETE                         = 100174,
    FREEDOM_CMDE_CREATURE_SELECT_ENTRY_ID           = 100175,
    FREEDOM_CMDE_CREATURE_SELECT_NOT_IN_WORLD       = 100176,
    FREEDOM_CMDI_CREATURE_SELECT                    = 100177,
    FREEDOM_CMDH_NPC_DELETE_ITEM                    = 100178,
    FREEDOM_CMDE_CREATURE_SELECT_VENDOR             = 100179,
    FREEDOM_CMDE_NPC_DELETE_ITEM_NOT_IN_LIST        = 100180,
    FREEDOM_CMDI_NPC_DELETE_ITEM                    = 100181,
    FREEDOM_CMDH_NPC_SET_FACTION_ID                 = 100182,
    FREEDOM_CMDE_NPC_SET_FACTION_INVALID_ID         = 100183,
    FREEDOM_CMDI_NPC_SET_FACTION_ID                 = 100184,
    FREEDOM_CMDH_NPC_SET_FLAG                       = 100185,
    FREEDOM_CMDI_NPC_SET_FLAG                       = 100186,
    FREEDOM_CMDH_NPC_SET_DATA                       = 100187,
    FREEDOM_CMDI_NPC_SET_DATA                       = 100188,
    FREEDOM_CMDI_NPC_FOLLOW                         = 100189,
    FREEDOM_CMDI_CREATURE_INFO                      = 100190,
    FREEDOM_CMDI_CREATURE_INFO_LI_GUID_FULL         = 100191,
    FREEDOM_CMDI_CREATURE_INFO_LI_GUID              = 100192,
    FREEDOM_CMDI_CREATURE_INFO_LI_ENTRY             = 100193,
    FREEDOM_CMDI_CREATURE_INFO_LI_DISPLAY_ID        = 100194,
    FREEDOM_CMDI_CREATURE_INFO_LI_PHASELIST         = 100195,
    FREEDOM_CMDI_CREATURE_INFO_LI_PHASE_LI          = 100196,
    FREEDOM_CMDI_CREATURE_INFO_LI_POS_X             = 100197,
    FREEDOM_CMDI_CREATURE_INFO_LI_POS_Y             = 100198,
    FREEDOM_CMDI_CREATURE_INFO_LI_POS_Z             = 100199,
    FREEDOM_CMDI_CREATURE_INFO_LI_FACTION_ID        = 100200,
    FREEDOM_CMDI_CREATURE_INFO_LI_NAME              = 100201,
    FREEDOM_CMDI_CREATURE_INFO_LI_AI_INFO           = 100202,
    FREEDOM_CMDI_CREATURE_INFO_LI_PHASEMASK         = 100203,
    FREEDOM_CMDI_CREATURE_INFO_LI_ORIENTATION       = 100204,
    FREEDOM_CMDI_CREATURE_INFO_LI_DISTANCE          = 100205,
    FREEDOM_CMDI_CREATURE_INFO_LI_SCALE             = 100206,
    FREEDOM_CMDI_CREATURE_INFO_LI_CREATOR_PLAYER    = 100207,
    FREEDOM_CMDI_CREATURE_INFO_LI_CREATOR_ACC       = 100208,
    FREEDOM_CMDI_CREATURE_INFO_LI_MODIFIER_PLAYER   = 100209,
    FREEDOM_CMDI_CREATURE_INFO_LI_MODIFIER_ACC      = 100210,
    FREEDOM_CMDI_CREATURE_INFO_LI_CREATED           = 100211,
    FREEDOM_CMDI_CREATURE_INFO_LI_MODIFIED          = 100212,
    FREEDOM_CMDI_CREATURE_INFO_LI_NO_HISTORY        = 100213,
    FREEDOM_CMDI_CREATURE_INFO_LI_SCRIPT_INFO       = 100214,
    FREEDOM_CMDI_CREATURE_INFO_LI_FLAGSE_LIST       = 100215,
    FREEDOM_CMDI_CREATURE_INFO_LI_FLAGSE_LI         = 100216,
    FREEDOM_CMDI_CREATURE_INFO_LI_NPCFLAGS_LIST     = 100217,
    FREEDOM_CMDI_CREATURE_INFO_LI_MECHANICIMM_LIST  = 100218,
    FREEDOM_CMDI_CREATURE_INFO_LI_MECHANICIMM_LI    = 100219,
    FREEDOM_CMDI_CREATURE_INFO_LI_UNITFLAGS_LIST    = 100220,
    FREEDOM_CMDI_CREATURE_INFO_LI_UNITFLAGS_LI      = 100221,
    FREEDOM_CMDI_CREATURE_INFO_LI_LEVEL             = 100222,
    FREEDOM_CMDI_CREATURE_INFO_LI_EQUIPMENT         = 100223,
    FREEDOM_CMDI_CREATURE_INFO_LI_HEALTH            = 100224,
    FREEDOM_CMDI_CREATURE_INFO_LI_INHABIT_TYPE      = 100225,
    FREEDOM_CMDI_CREATURE_INFO_LI_UNITFLAGS2        = 100226,
    FREEDOM_CMDI_CREATURE_INFO_LI_DYNFLAGS          = 100227,
    FREEDOM_CMDI_CREATURE_INFO_LI_FACTION_TEMPLATE  = 100228,
    FREEDOM_CMDI_CREATURE_INFO_LI_RESPAWN_TIMES     = 100229,
    FREEDOM_CMDI_CREATURE_INFO_LI_LOOT              = 100230,
    FREEDOM_CMDI_CREATURE_INFO_LI_DUNGEON_ID        = 100231,
    FREEDOM_CMDI_CREATURE_INFO_LI_ARMOR             = 100232,
    FREEDOM_CMDI_NPC_NEAR                           = 100233,
    FREEDOM_CMDI_NPC_NEAR_MAX_RESULT_COUNT          = 100234,
    FREEDOM_CMDI_NPC_NEAR_LIST_ITEM                 = 100235,
    FREEDOM_CMDI_CREATURE_MOVE                      = 100236,
    FREEDOM_CMDI_CREATURE_TURNED                    = 100237,
    FREEDOM_CMDH_NPC_SET_EMOTE                      = 100238,
    FREEDOM_CMDI_NPC_SET_EMOTE                      = 100239,
    FREEDOM_CMDH_NPC_SET_MOUNT                      = 100240,
    FREEDOM_CMDI_NPC_SET_MOUNT                      = 100241,
    FREEDOM_CMDH_NPC_SET_AURA                       = 100242,
    FREEDOM_CMDI_NPC_SET_AURA                       = 100243,
    FREEDOM_CMDH_NPC_SET_DEATHSTATE                 = 100244,
    FREEDOM_CMDI_NPC_SET_DEATHSTATE                 = 100245,
    FREEDOM_CMDH_NPC_SET_SLEEPSTATE                 = 100246,
    FREEDOM_CMDI_NPC_SET_SLEEPTSTATE                = 100247,
    FREEDOM_CMDH_NPC_SET_HOVERSTATE                 = 100248,
    FREEDOM_CMDI_NPC_SET_HOVERSTATE                 = 100249,
    FREEDOM_CMDH_NPC_PLAYEMOTE                      = 100250,
    FREEDOM_CMDI_NPC_PLAYEMOTE                      = 100251,
    FREEDOM_CMDH_NPC_SET_MODEL                      = 100252,
    FREEDOM_CMDI_NPC_SET_MODEL                      = 100253,
    FREEDOM_CMDH_NPC_SAY                            = 100254,
    FREEDOM_CMDH_NPC_TEXTEMOTE                      = 100255,
    FREEDOM_CMDH_NPC_WHISPER                        = 100256,
    FREEDOM_CMDH_NPC_YELL                           = 100257,
    FREEDOM_CMDE_NPC_UNFOLLOW_NOT_A_FOLLOWER        = 100258,
    FREEDOM_CMDI_NPC_UNFOLLOW                       = 100259,
    FREEDOM_CMDE_FREEDOM_TAME_ALREADY_HAVE_PET      = 100260,
    FREEDOM_CMDE_FREEDOM_TAME_NOT_TAMEABLE          = 100261,
    FREEDOM_CMDI_FREEDOM_TAME                       = 100262,
    FREEDOM_CMDE_FREEDOM_TAME_ALREADY_A_PET         = 100263,
    FREEDOM_CMDE_ENTRY_X_NOT_EXIST_IN_TABLE_X       = 100264,
    FREEDOM_CMDH_LOOKUP_ITEM                        = 100265,
    FREEDOM_CMDE_INVALID_MODIFIER_ARG_FOR_MOD_X     = 100266,
    FREEDOM_CMDE_MODIFIERS_CANNOT_BE_USED_TGTHR     = 100267,
    FREEDOM_CMDI_LOOKUP_ITEM_NONE_FOUND             = 100268,
    FREEDOM_CMDI_LOOKUP_ITEM                        = 100269,
    FREEDOM_CMDI_FREEDOM_PANDAHORDE                 = 100270,
    FREEDOM_CMDI_FREEDOM_PANDAALLIANCE              = 100271,
    FREEDOM_CMDE_FREEDOM_PANDA_NOT_NEUTRAL          = 100272,
    FREEDOM_CMDE_SERVICE_RESTRICTED_FOR_PANDAS      = 100273,
    FREEDOM_CMDE_SERVICE_RESTRICTED_FOR_NPANDAS     = 100274,
    FREEDOM_CMDI_RELOAD_WORLD_DB                    = 100275,
    FREEDOM_CMDI_RELOAD_EXECUTOR                    = 100276,
    FREEDOM_CMDI_RELOAD_FINISH                      = 100277,
    FREEDOM_CMDH_NPC_SET_BYTES1                     = 100278,
    FREEDOM_CMDH_NPC_SET_BYTES2                     = 100279,
    FREEDOM_CMDI_NPC_SET_BYTES1                     = 100280,
    FREEDOM_CMDI_NPC_SET_BYTES2                     = 100281,
    FREEDOM_CMDH_NPC_SET_SITGROUNDSTATE             = 100282,
    FREEDOM_CMDI_NPC_SET_SITGROUNDSTATE             = 100283,
    FREEDOM_CMDH_NPC_SET_SITLOWSTATE                = 100284,
    FREEDOM_CMDI_NPC_SET_SITLOWSTATE                = 100285,
    FREEDOM_CMDH_NPC_SET_SITMEDIUMSTATE             = 100286,
    FREEDOM_CMDI_NPC_SET_SITMEDIUMSTATE             = 100287,
    FREEDOM_CMDH_NPC_SET_SITHIGHSTATE               = 100288,
    FREEDOM_CMDI_NPC_SET_SITHIGHSTATE               = 100289,
    FREEDOM_CMDH_NPC_SET_KNEELSTATE                 = 100290,
    FREEDOM_CMDI_NPC_SET_KNEELSTATE                 = 100291,
    FREEDOM_CMDH_NPC_SET_SHEATHSTATE                = 100292,
    FREEDOM_CMDI_NPC_SET_SHEATHSTATE                = 100293,
    FREEDOM_CMDH_NPC_SET_GRAVITY                    = 100294,
    FREEDOM_CMDI_NPC_SET_GRAVITY                    = 100295,
    FREEDOM_CMDH_NPC_SET_SWIM                       = 100296,
    FREEDOM_CMDI_NPC_SET_SWIM                       = 100297,
    FREEDOM_CMDH_FREEDOM_TITLE_SET                  = 100298,
    FREEDOM_CMDE_FREEDOM_TITLE_SET_INVALID_TITLEID  = 100299,
    FREEDOM_CMDI_FREEDOM_TITLE_LIST_ITEM            = 100300,
    FREEDOM_CMDI_FREEDOM_TITLE_LIST_NONE_FOUND      = 100301,
    FREEDOM_CMDI_FREEDOM_TITLE_LIST                 = 100302,
    FREEDOM_CMDI_FREEDOM_TITLE_SET                  = 100303,
    FREEDOM_CMDI_FREEDOM_TITLE_SET_UNSET            = 100304,
    FREEDOM_CMDH_NPC_SET_FLYSTATE                   = 100305,
    FREEDOM_CMDI_NPC_SET_FLYSTATE                   = 100306,
    FREEDOM_CMDI_PINFO_START                        = 100307,
    FREEDOM_CMDI_PINFO_GAME_ACCOUNT                 = 100308,
    FREEDOM_CMDI_PINFO_BNET_ACCOUNT                 = 100309,
    FREEDOM_CMDI_PINFO_IP                           = 100310,
    FREEDOM_CMDI_PINFO_EMAIL                        = 100311,
    FREEDOM_CMDI_PINFO_LAST_LOGIN                   = 100312,
    FREEDOM_CMDI_PINFO_ONLINE                       = 100313,
    FREEDOM_CMDI_PINFO_ALIVE                        = 100314,
    FREEDOM_CMDI_PINFO_GM_TOGGLE                    = 100315,
    FREEDOM_CMDI_PINFO_BANNED                       = 100316,
    FREEDOM_CMDI_PINFO_PLAYED_TIME                  = 100317,
    FREEDOM_CMDI_PINFO_RACE                         = 100318,
    FREEDOM_CMDI_PINFO_CLASS                        = 100319,
    FREEDOM_CMDI_PINFO_MAP                          = 100320,
    FREEDOM_CMDI_PINFO_PHASEMASK                    = 100321,
    FREEDOM_CMDI_PINFO_GUILD                        = 100322,
    FREEDOM_CMDI_PINFO_GUILD_NOTE                   = 100323,
    FREEDOM_CMDI_PINFO_GUILD_OFFICER_NOTE           = 100324,
    FREEDOM_CMDI_PINFO_PHASEMASK_GM_ON              = 100325,
    FREEDOM_CMDI_PINFO_BAN_INFO                     = 100326,
    FREEDOM_CMDI_PINFO_BAN_INFO_LI_REASON           = 100327,
    FREEDOM_CMDI_PINFO_BAN_INFO_LI_LENGTH           = 100328,
    FREEDOM_CMDI_PINFO_BAN_INFO_LI_BANNED_BY        = 100329,
    FREEDOM_CMDI_PINFO_BAN_INFO_LI_TYPE             = 100330,
    FREEDOM_CMDI_PINFO_MUTE_INFO                    = 100331,
    FREEDOM_CMDI_PINFO_MUTE_INFO_LI_REASON          = 100332,
    FREEDOM_CMDI_PINFO_MUTE_INFO_LI_LENGTH          = 100333,
    FREEDOM_CMDI_PINFO_MUTE_INFO_LI_BANNED_BY       = 100334,
    FREEDOM_CMDH_FREEDOM_GUILD_CREATE               = 100335,
    FREEDOM_CMDI_FREEDOM_GUILD_CREATE               = 100336,
    FREEDOM_CMDE_FREEDOM_GUILD_CREATE_ALREADY_IN    = 100337,
    FREEDOM_CMDE_FREEDOM_GUILD_CREATE_FAILED        = 100338,
    FREEDOM_CMDH_GOBJECT_AXIAL                      = 100339,
    FREEDOM_CMDI_GOBJECT_AXIAL                      = 100340,
    FREEDOM_CMDH_GOBJECT_ROLL                       = 100341,
    FREEDOM_CMDI_GOBJECT_ROLL                       = 100342,
    FREEDOM_CMDH_GOBJECT_PITCH                      = 100343,
    FREEDOM_CMDI_GOBJECT_PITCH                      = 100344,
    FREEDOM_CMDH_GOBJECT_YAW                        = 100345,
    FREEDOM_CMDI_GOBJECT_YAW                        = 100346,
    ...
    /* 100354 - 100358 to possibly be re-added w/relevant commands */
    FREEDOM_CMDE_ACCT_INDEX_NO_MATCH                = 100359,
    FREEDOM_CMDH_GAMEACCOUNTCREATE                  = 100360,
    FREEDOM_CMDI_CREATURE_INFO_PHASESHIFT           = 100361,
    FREEDOM_CMDH_ACCOUNTACCESS                      = 100362,
    FREEDOM_CMDE_ACCOUNTACCESS_SAMELEVEL            = 100363,
    FREEDOM_CMDE_ACCOUNTACCESS_CONFIRM              = 100364,
    FREEDOM_CMDI_ACCOUNTACCESS_DONE                 = 100365,
    ...
    FREEDOM_CMDI_BPET_LIST_ITEM                     = 100370,

    FREEDOM_CMDI_CREATURE_INFO_LI_FORMATION         = 100371,
    FREEDOM_CMDI_CREATURE_INFO_LI_FORMATION_NONE    = 100372,
    FREEDOM_CMDI_FORMATION_LIST_ITEM                = 100373,
    FREEDOM_CMDI_FORMATION_LIST_ITEM_ALL            = 100374,
};
#endif
