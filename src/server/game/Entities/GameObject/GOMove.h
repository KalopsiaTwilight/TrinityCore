...
public:
    ...
    static GameObject* SpawnGameObject(Player* player, float x, float y, float z, float o, PhaseShift p, uint32 entry);
    static GameObject* MoveGameObject(Player* player, float x, float y, float z, float o, PhaseShift p, ObjectGuid::LowType lowguid);
