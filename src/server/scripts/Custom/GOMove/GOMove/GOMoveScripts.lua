...
-- MAIN FRAME
local MainFrame = GOMove:CreateFrame("GOMove_UI", 170, 540)
...
local PITCH_POS = GOMove:CreateButton(MainFrame, "Pitch+", 45, 25, 0, -475)
function PITCH_POS:OnClick()
    GOMove:Move("PITCH_POS", AXIAL:GetNumber())
end
local YAW_POS = GOMove:CreateButton(MainFrame, "Yaw+", 45, 25, 50, -475)
function YAW_POS:OnClick()
    GOMove:Move("YAW_POS", AXIAL:GetNumber())
end
local ROLL_NEG = GOMove:CreateButton(MainFrame, "Roll-", 45, 25, -50, -500)
function ROLL_NEG:OnClick()
    GOMove:Move("ROLL_NEG", AXIAL:GetNumber())
end
local PITCH_NEG = GOMove:CreateButton(MainFrame, "Pitch-", 45, 25, 0, -500)
function PITCH_NEG:OnClick()
    GOMove:Move("PITCH_NEG", AXIAL:GetNumber())
end
local YAW_NEG = GOMove:CreateButton(MainFrame, "Yaw-", 45, 25, 50, -500)
function YAW_NEG:OnClick()
    GOMove:Move("YAW_NEG", AXIAL:GetNumber())
end
