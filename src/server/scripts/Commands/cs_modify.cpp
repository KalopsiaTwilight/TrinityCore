...
public:
    ...
    ChatCommand* GetCommands() const OVERRIDE
    {
        static ChatCommand modifyspeedCommandTable[] =
        {
            ...
            { "",               RBAC_PERM_MODERATOR_COMMANDS,      false, &HandleModifySpeedCommand,        "", NULL },
        ...
        static ChatCommand modifyCommandTable[] =
        {
            ...
            { "scaleperm",      RBAC_PERM_ADMINISTRATOR_COMMANDS,  false, &HandleModifyPermScaleCommand,     "", NULL },
            { "morphperm",      RBAC_PERM_ADMINISTRATOR_COMMANDS,  false, &HandleModifyPermMorphCommand,     "", NULL },
            { "bytes1",         RBAC_PERM_GAMEMASTER_COMMANDS,     false, &HandleModifyBytes1Command,        "", NULL },
            { "bytes2",         RBAC_PERM_GAMEMASTER_COMMANDS,     false, &HandleModifyBytes2Command,        "", NULL },
            { NULL,             0,                  false, NULL,                                           "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            //{ "morph",          RBAC_PERM_GAMEMASTER_COMMANDS,     false, &HandleModifyMorphCommand,          "", NULL }, -- Custom, have a separate command for .morph
