...
public:
    ...
    ChatCommand* GetCommands() const OVERRIDE
    {
        static ChatCommand commandTable[] =
        {
            ...
            { "playerinfo",       rbac::RBAC_PERM_COMMAND_PINFO,             true, &HandlePInfoCommand,            "", NULL }, // CUSTOM
            ...
            { "scale",            rbac::RBAC_PERM_COMMAND_SCALE,            false, &HandleSelfScaleCommand,        "", NULL },
            { "playlocal",        rbac::RBAC_PERM_COMMAND_PLAYLOCAL,        false, &HandlePlayLocalCommand,        "", NULL },
            { "morph",            rbac::RBAC_PERM_COMMAND_SELFMORPH,        false, &HandleSelfMorphCommand,        "", NULL },
            { "additemall",       rbac::RBAC_PERM_COMMAND_ADDITEMALL,       false, &HandleAddItemAllCommand,       "", NULL },
            { "unauraall",        rbac::RBAC_PERM_COMMAND_UNAURAALL,        false, &HandleUnAuraAllCommand,        "", NULL },
            { "masssummon",       rbac::RBAC_PERM_COMMAND_MASSSUMMON,       false, &HandleMassSummonCommand,       "", NULL },
