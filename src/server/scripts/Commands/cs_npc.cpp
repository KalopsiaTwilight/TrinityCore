...
public:
    ...
    ChatCommand* GetCommands() const OVERRIDE
    {
        ...
        static ChatCommand npcSetCommandTable[] =
        {
            ...
            // CUSTOM
            { "dynflags",   rbac::RBAC_PERM_COMMAND_NPC_SET_DYNFLAGS,  false, &HandleNpcSetDynamicFlagsCommand,   "", NULL },
            { "unitflags",  rbac::RBAC_PERM_COMMAND_NPC_SET_UNITFLAGS, false, &HandleNpcSetUnitFlagsCommand,      "", NULL },
            { NULL,         0,                                   false, NULL,                              "", NULL }
        };
        static ChatCommand npcCommandTable[] =
        {
            ...
            // CUSTOM
            { "emote",     rbac::RBAC_PERM_COMMAND_NPC_TEXTEMOTE, false, &HandleNpcTextEmoteCommand,         "", NULL },
            { "return",    rbac::RBAC_PERM_COMMAND_NPC_RETURN,    false, &HandleNpcReturnCommand,            "", NULL },
            { "scale",     rbac::RBAC_PERM_COMMAND_NPC_SCALE,     false, &HandleNpcCustScaleCommand,         "", NULL },
            { "faction",   rbac::RBAC_PERM_COMMAND_NPC_FACTION,   false, &HandleNpcCustFactCommand,          "", NULL },
            { "attack",    rbac::RBAC_PERM_COMMAND_NPC_ATTACK,    false, &HandleNpcAttackCommand,            "", NULL },
            { NULL,        0,                               false, NULL,                               "", NULL }
        };
