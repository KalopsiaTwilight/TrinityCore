...
public:
    ...
    ChatCommand* GetCommands() const OVERRIDE
    {
        ...
        static ChatCommand npcSetCommandTable[] =
        {
            ...
            // CUSTOM
            { "dynflags",   RBAC_PERM_COMMAND_NPC_SET_DYNFLAGS,  false, &HandleNpcSetDynamicFlagsCommand,   "", NULL },
            { "unitflags",  RBAC_PERM_COMMAND_NPC_SET_UNITFLAGS, false, &HandleNpcSetUnitFlagsCommand,      "", NULL },
            { NULL,         0,                                   false, NULL,                              "", NULL }
        };
        static ChatCommand npcCommandTable[] =
        {
            ...
            { "attack",    RBAC_PERM_COMMAND_NPC_ATTACK,    false, &HandleNpcAttackCommand,            "", NULL },
            { NULL,        0,                               false, NULL,                               "", NULL }
        };
