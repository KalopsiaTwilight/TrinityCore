...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        ...
        static ChatCommand lookupCommandTable[] =
        {
            ...
            { "pobject",  rbac::RBAC_PERM_COMMAND_LOOKUP_POBJECT,  true, &HandleLookupPObjectCommand,  "", NULL },
            { NULL,       0,                                false, NULL,                         "", NULL }
        };
    ...
    static bool HandleLookupPObjectCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
