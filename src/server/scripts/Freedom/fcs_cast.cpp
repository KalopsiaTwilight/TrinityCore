...
{
public:
    fcast_commandscript() : CommandScript("fcast_commandscript") { }
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        static std::vector<ChatCommand> castCommandTable =
        {
            ...
            { "player", rbac::RBAC_FPERM_COMMAND_CAST_PLAYER, false, &HandleCastPlayerCommand,"" },
            { "all",    rbac::RBAC_FPERM_COMMAND_CAST_ALL,    false, &HandleCastAllCommand,   "" },
