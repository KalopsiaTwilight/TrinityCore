...
{
public:
    fmodify_commandscript() : CommandScript("fmodify_commandscript") { }
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        static std::vector<ChatCommand> modifyCommandTable =
        {
            ...
            { "speed",          rbac::RBAC_PERM_COMMAND_MODIFY_SPEED,           false, &HandleModifyASpeedCommand,          "" },
